...
if user_menu == 'Overall Analysis':
    ...
    pivot_table = df.drop_duplicates(['Year', 'Sport', 'Event']) \
    ...
    # Create a list of unique sports and include 'Overall'
    ...
    # Get the most successful athletes based on the selected sport
